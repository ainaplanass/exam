...
1. **Estudia** `dip-bad.cs` - identifica el acoplamiento fuerte
2. **Implementa** tu solución en `dip-exercise.cs` antes de ver la propuesta
3. **Observa** `dip-good.cs` y compara con tu solución
